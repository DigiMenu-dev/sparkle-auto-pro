...
export const ServiceCard = ({ service, onSelect }: ServiceCardProps) => {
  ...
  return (
    <Card className="group relative overflow-hidden hover:shadow-[var(--shadow-primary)] transition-[var(--transition-smooth)] cursor-pointer bg-[var(--gradient-card)]">
      <div className="p-6">
        ...
        <div className="mb-4">
          <p className="text-2xl font-bold bg-[var(--gradient-primary)] bg-clip-text text-transparent">
            {service.price}
          </p>
        </div>
        ...
        <Button 
          ...
          className="w-full bg-[var(--gradient-primary)] hover:shadow-[var(--shadow-primary)] border-0 transition-[var(--transition-smooth)]"
        >
